      ...
      <div class="row">
        <div class="centering" style="background-color: #5576C4; ">
          <div class="card rounded shadow " style="background-color: #fefefe; ">
            <div class="card-body">           
            		<h4 class="card-title text-center mt-3">Mark OFF - Days</h4>
					<hr>
					<?php
						if(isset($_SESSION['dateshifterror']) && $_SESSION['dateshifterror'] == 0)
						{
					?>
						  <div class="alert alert-success text-center" role="alert">
						    <strong>Yaay!</strong> Date Shift Success
						  </div>
					<?php
						}
						unset($_SESSION['dateshifterror']);
					?>
					<form class="col-12 pl-lg-4 pr-lg-4 pt-lg-2" action="markhol.php" method="POST">
					<div class="form-group">				
					  <label class="mt-3" for="password">Date to be marked as holiday</label>
					  <input type="date" class="form-control" id="password" style="border-radius: 25px;" aria-describedby="emailHelp" placeholder="Enter Topic" name="bdate" required="true">
					</div>
					<div class="d-flex justify-content-center">
					  <button type="submit" class="btn btn-success btn-block mb-2 mt-3" style="color: white; border-radius: 25px;">Mark as holiday</button>  
					</div>
					</form>
